# -*- coding: utf-8 -*-
"""LVADSUSR154_HareeshKumaar_Fin_Lab2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11Td3f3hUkaLcbrwARn6PIrB_6f9lOdl_
"""
...
#outlier treatment
df.loc[df['bill_length_mm']>59.1625,'bill_length_mm']=59.1625
df.loc[df['bill_length_mm']<25.8625,'bill_length_mm']=25.8625
...
x = df.drop(columns = ['year','species','island','bill_length_mm'])
y = df[['species']]
